class Bot {
    ...
    makeMove(gamestate) {
        ...
        if (typeof round !== 'undefined') {
            ...
            if (this.counterOpeningDynamiteAttack(gamestate) === 'W') {return 'W';}
            if (this.endgameMethods(round) !== undefined) {return this.endgameMethods(round);}
            if (this.tiebreakStrategy(round) !== undefined) {return this.tiebreakStrategy(round);}
    ...
    endgameMethods(round) {
        if ((100 - this.dynamiteUsed) >= (1000 - this.myPoints)) {
            return this.useDynamite();
        }
        if (this.opponentsDynamite >= (1000 - this.oppPoints)) {
            if (round.p2 === 'D') {
                return 'W'
            }
        }
        if ((100 - this.dynamiteUsed) >= (1000 - this.oppPoints)) {
            return this.useDynamite();
        }
    }
