!function (e) {
    ...
    const {BotError: o} = r(0), n = ["R", "P", "S", "W", "D"];
    e.exports = class {
        constructor(e, t, r, o) {
        ...
        updateScore(e) {
            if (!n.includes(e[1])) throw new o(1, "invalidMove", e[1]);
            if (!n.includes(e[2])) throw new o(2, "invalidMove", e[2]);
        ...
        handleBotError(e, t) {
            throw e.response && e.response.body && "InvalidMoveError" === e.response.body.errName ? new o(t, "invalidMove") : new o(t, "error", e)
        }
    ...
    e.exports = function (e, t, r, s, a, i) {
        return r.createInstance(e).then(c => s.createInstance(t).then(n => (n => {
            const i = new o(n, r, s, a);
            return i.play().then(r => (i.deleteBots(), r.botIds = {1: e, 2: t}, r))
        })([c, n]), o => (i.error(`Error creating bot ${t}: ` + o), r.deleteInstance(c), n(e, t, 2)))).catch(r => (i.error(`Error creating bot ${e}: ` + r), n(e, t, 1)))
    }
}, function (e, t) {
